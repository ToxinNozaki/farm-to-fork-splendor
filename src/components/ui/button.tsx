  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury:
          "bg-[image:var(--gradient-gold)] text-primary-foreground shadow-[var(--shadow-gold)] hover:-translate-y-0.5 hover:shadow-[0_22px_52px_-24px_var(--color-primary)]",
        reserve:
          "border border-primary/50 bg-card/45 text-foreground backdrop-blur hover:-translate-y-0.5 hover:border-primary hover:bg-secondary",
      },
      size: {
